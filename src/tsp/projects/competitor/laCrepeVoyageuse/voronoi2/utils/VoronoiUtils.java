...
import tsp.projects.competitor.laCrepeVoyageuse.voronoi2.fortune.SweepLine;
...
public class VoronoiUtils {
     ...
     * @param pilePoints Pile de points
     * @param circles Liste de cercles
     * @throws Exception
     */
    public static void searchAndSaveNewCircles(BeachLine beachLine, SweepLine sweepLine, ArrayList<Point> pilePoints, ArrayList<String> circles) throws Exception {
            ...
            for (int i = 0; i < zones.size() - 2; i++) {
                ...
                if (nextPoints.size() == 3) {
                    ...
                    if (VoronoiUtils.checkCircleDoesntExist(newCircleId, circles)) {
                        ...
                        try {
                            Circle circle = new Circle(nextPoints, newCircleId);
     ...
     */
    private static boolean checkCircleDoesntExist(String newId, ArrayList<String> circles) {
     ...
     * @return Résultat de la vérification
     */
    private static boolean recCheckCircleDoesntExist(String newId, ArrayList<String> circles, int index) {
        ...
        else if (circles.get(index).equals(newId)) {
            return false;
        }
