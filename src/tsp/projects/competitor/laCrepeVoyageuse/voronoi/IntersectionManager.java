...
public class IntersectionManager {
     ...
     */
    public static ArrayList<Point> getIntersections(Point point1, Point point2) throws Exception {
         ...
         */
        ArrayList<Point> listSolutions1 = IntersectionManager.getSolutionsWithDelta(point1, point2);
        ArrayList<Point> listSolutions2 = IntersectionManager.getSolutionsWithDelta(point2, point1);
     ...
     * @return Liste de points représentants les points d'intersection
     */
    private static ArrayList<Point> getSolutionsWithDelta(Point point1, Point point2) throws Exception {
