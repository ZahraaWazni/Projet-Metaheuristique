...
import tsp.projects.competitor.laCrepeVoyageuse.voronoi.Point;
...
public class DrawAWT {
     ...
     * @param graphics2D Graphique
     * @param neighbours Liste de voisins
     * @param color Couleur des liens entre les voisins
     */
    public static void drawLinks(Graphics2D graphics2D, ArrayList<Neighbour> neighbours, Color color) {
        ...
        for (Neighbour n : neighbours) {
            ...
            for (Neighbour other : n.getNeighbours()) {
